# Quality Assurance Codebase Review
This quality assurance report checks the complete in-scope codebase. I reviewed the entire codebase and identified several issues. The examination covered all relevant aspects to ensure comprehensive coverage. The findings include specific vulnerabilities and potential risks. Below is a detailed summary of the detected issues.
This report is quite lengthy, and there may be some duplicate issues similar to those in the bot report, particularly around issues 8 or 9.
### Low Risk Issues

| |Issue|Instances|
|-|:-|:-:|
| [[L001](#l001---abiencodepacked-should-not-be-used-with-dynamic-types-when-passing-the-result-to-a-hash-function-such-as-keccak256)] | `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()` | 10 |
| [[L002](#l002---initializers-could-be-front-run)] | Initializers could be front-run | 2 |
| [[L003](#l003---loss-of-precision-due-to-division-by-large-numbers)] | Loss of precision due to division by large numbers | 1 |
| [[L004](#l004---array-lengths-not-checked)] | Array lengths not checked | 2 |
| [[L005](#l005---require-should-be-used-instead-of-assert)] | `require()` should be used instead of `assert()` | 2 |
| [[L006](#l006---missing-checks-for-address0x0-when-assigning-values-to-address-state-variables)] | Missing checks for `address(0x0)` when assigning values to address state variables | 2 |
| [[L007](#l007---upgradeable-contract-is-missing-a-__gap50-storage-variable-to-allow-for-new-storage-variables-in-later-versions)] | Upgradeable contract is missing a __gap[50] storage variable to allow for new storage variables in later versions | 2 |
| [[L008](#l008---use-ownable2step-rather-than-ownable)] | Use `Ownable2Step` rather than `Ownable` | 2 |
| [[L009](#l009---unsafe-downcast)] | Unsafe downcast | 3 |
| [[L010](#l010---upgradeable-contract-not-initialized)] | Upgradeable contract not initialized | 2 |
| [[L011](#l011---use-of-txorigin-is-unsafe-in-almost-every-context)] | Use of `tx.origin` is unsafe in almost every context | 1 |
| [[L012](#l012---setters-should-have-initial-value-check)] | Setters should have initial value check | 3 |
| [[L013](#l013---empty-receivepayable-fallback-function-does-not-authorize-requests)] | Empty `receive()`/`payable fallback()` function does not authorize requests | 1 |
| [[L014](#l014---contracts-are-designed-to-receive-eth-but-do-not-implement-function-for-withdrawal)] | Contracts are designed to receive ETH but do not implement function for withdrawal | 1 |
| [[L015](#l015---functions-calling-contractsaddresses-with-transfer-hooks-are-missing-reentrancy-guards)] | Functions calling contracts/addresses with transfer hooks are missing reentrancy guards | 2 |
| [[L016](#l016---int-casting-blocktimestamp-can-reduce-the-lifespan-of-a-contract)] | Int casting `block.timestamp` can reduce the lifespan of a contract | 1 |
| [[L017](#l017---no-limits-when-setting-state-variable-amounts)] | No limits when setting state variable amounts | 5 |
| [[L018](#l018---pausing-withdrawals-is-unfair-to-the-users)] | Pausing withdrawals is unfair to the users | 1 |
| [[L019](#l019---constructorinitialize-function-lacks-parameter-validation)] | constructor/initialize function lacks parameter validation | 5 |
| [[L020](#l020---for-loops-in-public-or-external-functions-should-be-avoided-due-to-high-gas-costs-and-possible-dos)] | For loops in `public` or `external` functions should be avoided due to high gas costs and possible DOS | 4 |
| [[L021](#l021---external-calls-in-an-unbounded-for-loop-may-result-in-a-dos)] | External calls in an unbounded for-loop may result in a DoS | 4 |
| [[L022](#l022---contracts-are-not-using-their-oz-upgradeable-counterparts)] | Contracts are not using their OZ Upgradeable counterparts | 11 |
| [[L023](#l023---consider-implementing-two-step-procedure-for-updating-protocol-addresses)] | Consider implementing two-step procedure for updating protocol addresses | 2 |
| [[L024](#l024---missing-checks-for-address0x0-in-the-constructor)] | Missing checks for address(0x0) in the constructor | 3 |
| [[L025](#l025---governance-functions-should-be-controlled-by-time-locks)] | Governance functions should be controlled by time locks | 3 |
| [[L026](#l026---code-does-not-follow-the-best-practice-of-check-effects-interaction)] | Code does not follow the best practice of check-effects-interaction | 3 |
| [[L027](#l027---missing-checks-for-address0x0-when-updating-address-state-variables)] | Missing checks for address(0x0) when updating address state variables | 7 |
| [[L028](#l028---the-setter-does-not-set-a-state-variable-or-call-a-fuction)] | The setter does not set a state variable or call a fuction | 2 |
| [[L029](#l029---prefer-continue-over-revert-model-in-iteration)] | Prefer continue over revert model in iteration | 2 |

Total: 89 instances over 29 issues
...
| |Issue|Instances|
|-|:-|:-:|
| [[NC001](#nc001---todo-left-in-the-code)] | TODO Left in the code | 1 |
| [[NC002](#nc002---constants-should-be-defined-rather-than-using-magic-numbers)] | Constants should be defined rather than using magic numbers | 6 |
| [[NC003](#nc003---event-is-not-properly-indexed)] | Event is not properly indexed | 1 |
| [[NC004](#nc004---function-ordering-does-not-follow-the-solidity-style-guide)] | Function ordering does not follow the Solidity style guide | 11 |
| [[NC005](#nc005---imports-could-be-organized-more-systematically)] | Imports could be organized more systematically | 19 |
| [[NC006](#nc006---constants-in-comparisons-should-appear-on-the-left-side)] | Constants in comparisons should appear on the left side | 15 |
| [[NC007](#nc007---else-block-not-required)] | else-block not required | 6 |
| [[NC008](#nc008---events-may-be-emitted-out-of-order-due-to-reentrancy)] | Events may be emitted out of order due to reentrancy | 4 |
| [[NC009](#nc009---if-statement-can-be-converted-to-a-ternary)] | If-statement can be converted to a ternary | 3 |
| [[NC010](#nc010---import-declarations-should-import-specific-identifiers-rather-than-the-whole-file)] | Import declarations should import specific identifiers, rather than the whole file | 10 |
| [[NC011](#nc011---public-functions-not-called-by-the-contract-should-be-declared-external-instead)] | Public functions not called by the contract should be declared external instead | 4 |
| [[NC012](#nc012---constant-redefined-elsewhere)] | Constant redefined elsewhere | 1 |
| [[NC013](#nc013---multiple-addressid-mappings-can-be-combined-into-a-single-mapping-of-an-addressid-to-a-struct-for-readability)] | Multiple `address`/ID mappings can be combined into a single `mapping` of an `address`/ID to a `struct`, for readability | 2 |
| [[NC014](#nc014---duplicated-requirerevert-checks-should-be-refactored-to-a-modifier-or-function)] | Duplicated `require()`/`revert()` checks should be refactored to a modifier or function | 2 |
| [[NC015](#nc015---variables-need-not-be-initialized-to-zero)] | Variables need not be initialized to zero | 6 |
| [[NC016](#nc016---use-a-more-recent-version-of-solidity)] | Use a more recent version of solidity | 10 |
| [[NC017](#nc017---variable-names-that-consist-of-all-capital-letters-should-be-reserved-for-constantimmutable-variables)] | Variable names that consist of all capital letters should be reserved for constant/immutable variables | 2 |
| [[NC018](#nc018---consider-using-delete-rather-than-assigning-falsezero-to-clear-values)] | Consider using delete rather than assigning false/zero to clear values | 3 |
| [[NC019](#nc019---variable-names-for-immutables-should-use-constant_case)] | Variable names for `immutable`s should use CONSTANT_CASE | 7 |
| [[NC020](#nc020---lines-are-too-long)] | Lines are too long | 102 |
| [[NC021](#nc021---file-is-missing-natspec-comments)] | File is missing NatSpec comments | 7 |
| [[NC022](#nc022---function-declarations-should-have-natspec-descriptions)] | Function declarations should have NatSpec descriptions | 22 |
| [[NC023](#nc023---contract-declarations-should-have-notice-tags)] | Contract declarations should have `@notice` tags | 24 |
| [[NC024](#nc024---error-declarations-should-have-natspec-descriptions)] | Error declarations should have NatSpec descriptions | 1 |
| [[NC025](#nc025---contract-does-not-follow-the-solidity-style-guides-suggested-layout-ordering)] | Contract does not follow the Solidity style guide's suggested layout ordering | 4 |
| [[NC026](#nc026---non-externalpublic-variable-names-should-begin-with-an-underscore)] | Non-external/public variable names should begin with an underscore | 4 |
...
| [[NC107](#nc107---contract-definitions-should-have-natspec-author-annotations)] | Contract definitions should have Natspec @author annotations | 12 |
...
## L025 - Governance functions should be controlled by time locks:
...
## NC011 - Public functions not called by the contract should be declared external instead:
...
## NC012 - Constant redefined elsewhere:
...
## NC016 - Use a more recent version of solidity:
...
## NC018 - Consider using delete rather than assigning false/zero to clear values:
...
## NC019 - Variable names for `immutable`s should use CONSTANT_CASE:
...
## NC024 - Error declarations should have NatSpec descriptions:
...
## NC100 - Library declarations should have Natspec @title annotations:
...
## NC101 - Library declarations should have Natspec @author annotations:
...
## NC102 - Library declarations should have Natspec @notice annotations:
...
## NC103 - Library declarations should have Natspec @dev annotations:
...
## NC104 - Modifier definitions should have Natspec @notice annotations:
...
## NC105 - Modifier definitions should have Natspec @dev annotations:
...
## NC106 - Contract definitions should have Natspec @title annotations:
...
## NC107 - Contract definitions should have Natspec @author annotations:
...
## NC108 - Contract definitions should have Natspec @notice annotations:
...
## NC109 - Contract definitions should have Natspec @dev annotations:
...
## NC110 - Event definitions should have Natspec @notice annotations:
...
## NC111 - State variable declarations should have Natspec @notice annotations:
...
## NC112 - State variable declarations should have Natspec @dev annotations:
...
## NC113 - Functions should have Natspec @return annotations:
...
## NC114 - Functions should have Natspec @param annotations:
...
## NC115 - Missing events in sensitive functions:
...
## NC116 - If statement control structures do not comply with best practices:
...
## NC117 - A event should be emitted if a non immutable state variable is set in a constructor:
...
## NC118 - Public state arrays should have a getter to return all elements:
...
## NC119 - It is best practice to use linear inheritance:
...
## NC120 - Consider only defining one library/interface/contract per sol file:
...
## NC121 - Use a struct to encapsulate multiple function parameters:
...
## NC122 - Avoid defining a function in a single line including it's contents:
...
## NC123 - Empty bytes check is missing:
...
## NC124 - Defining All External/Public Functions in Contract Interfaces:
...
## NC125 - Avoid declaring variables with the names of defined functions within the project:
